...
@Component({
    selector: 'template-form-group-list',
    templateUrl: './001_template-FormGroup-list.component.html',
    styles: [`
        .ng-valid[required] {
...
export class TemplateFormGroupListComponent {
    title = 'model-forms as template FormGroup';
